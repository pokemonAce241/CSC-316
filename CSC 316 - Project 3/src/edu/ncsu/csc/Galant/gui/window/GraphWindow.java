 ...
 *
 * $Id: GraphWindow.java 103 2015-03-26 20:46:06Z mfms $
 */
	...
	public GraphWindow(GraphDispatch _dispatch) {
		...
		gp.addMouseMotionListener( new MouseMotionListener() {
                @Override
                    ...
                    // releasing it
                    if ( ! dispatch.isAnimationMode() && ! dispatch.getWorkingGraph().isLayered() ) {
		...
		gp.addMouseListener( new MouseAdapter() {
                ...
                @Override
                    ...
                    } // not in animation mode nor layered
                }
            }
            );
...
//  [Last modified: 2015 03 26 at 20:38:15 GMT]
