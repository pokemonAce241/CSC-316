...
/**
 * The main ui of the balanced program to take user commands to add tickets, remove tickets, print 
 * the position of a ticket, or remove the highest ticket in a balanced map.
...
public class BalancedHelpTickets {
	...
	/**
	 * This function takes a string command form the string array parameter
	 * and does a specific action depending on what the string command is.The 
	 ...
	 * @return string
	 *               returns a specific string depending what action was done. 
	 * @throws Warning
	...
	/**
	 * This function takes a priority parameter, creates a new
	 * ticket object, and adds it to the queue.  If either the map or queue already has
	 ...
	 * 
	 * @return String
	 *               returns a string message once a ticket has been added.
	 */
	 ...
	 * 
	 * @return String
	 *               returns a string message once a ticket has been removed.
	 */
	 ...
	 * or if the map is empty.
	 * @return String
	 *               returns a string message once the ticket with the 
	 ...
	 * or if the map is empty.
	 * @return String
	 *               returns a string message once the ticket is found and
