...
/**
 * This takes object data and stores it in a AVL map and also manages any
...
public class AVLMap<K, V> implements Map<K, V> {
	 ...
	 * 
	 * @return Returns the total count of entries in the list.
	 */
	public int size() {
		return size;
	}
	...
	/**
	 * This function restructures the map in order to keep the map in its proper
	 * format after a entry addition or removal.
	 * 
	 * @param entry
	 *            The entry that is where the map will be rearranged to make the
	 *            map stay in AVL format.
	 */
	...
	/**
	 * Takes the entry in the parameter and rotates and its decendents to the
	 * left to keep the avl map in order.
	 * 
	 * @param entry
	 *            the entry we are rotating the other entries around.
	 * @return entry returns the new entry that was rotated into the parameter
	 *         entries spot.
	 */
	...
	/**
	 * Takes the entry in the parameter and rotates and its decendents to the
	 * right to keep the avl map in order.
	 * 
	 * @param entry
	 *            the entry we are rotating the other entries around.
	 * @return entry returns the new entry that was rotated into the parameter
	...
	/**
	 * This is a public class that allows the program to print out the avl map.
	 * 
	 * @author Gitesh Agarwal, Mohamad Saleh, Jason Benckert
	 * 
	 */
	public class TreePrint {
		 ...
		 * 
		 * @param v
		 *            The entry from where to start printing the map
		 * @param printer
		 *            the IndentPrinter to print the map
		 */
