/**
 * A heuristic class that takes a text word from a txt file and 
 * swaps its word counter with the text word before it in the
 * list unless it is a new word being added to the list. 
 * 
 * @author 
 *
 */
public class Transpose extends Naive {
	...
	/**
	 * constructor for Transpose class that creates a new 
	 ...
	 * representation of a text word and swaps it count with the word 
	 * before it were afterwords it increments its count. If the word
	 * is new it simply adds the word to the front of the list.
	 * 
