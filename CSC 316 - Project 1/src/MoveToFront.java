...
public class MoveToFront extends Naive {
	...
	/**
	 * constructor for MoveToFront class that creates a new input Scanner from a
	...
	/**
	 * Updates the list so that it a word of text that adds the word to the
	 * front of the list if the word is new and increments its count. If the
	 * word is already in the list then its count is incremented by one.
	 * 
	 * @param node
