...
/**
 * A heuristic class that takes the words in a text file and stores each word in
 * a tree map using each text word as a key with a word count object as a value.
 * 
...
public class MapWords extends Heuristic {
	...
	/**
	 * The tree map that stores and manages the WordWithCount objects passed
	 * into it.
	 */
	TreeMap<String, WordWithCount> map;

	/**
	 * constructor for MapWords class that creates a new input Scanner from a
	...
	/**
	 * sets up and initializes the TreeMap and wordComparator needed for this
	 * class.
	 */
	...
	/**
	 * This either adds a new word key or increases the word count of a word
	 * object in a word key depending on wither the word in already in the list
	 * or is a new word.
	 * 
	 * @param word
	 *            the word to lookup and update in the list
	 */
